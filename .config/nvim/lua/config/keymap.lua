...
wk.register({
  ...
  g = {
    ...
    -- t = { ':Gitsigns toggle_current_line_blame<cr>', '[t]oggle current line blame' },
    -- t = { ':GitBlameToggle<cr>', '[t]oggle current line blame' }, -- this is a bit more verbose and I like it. I've moved to only <leader>gb since I won't use all those GitBlame features anyway.
    ...
    -- TODO: Add git-conflict mappings into here. Also check that plugin out in general bc it seems good for conflicts
    d = {
      name = '[d]iff',
      o = { ':DiffviewOpen<cr>', '[o]pen' },
      c = { ':DiffviewClose<cr>', '[c]lose' },
    },
    b = { ':GitBlameToggle<cr>', 'toggle [b]lame' }, -- let's face it, I will not use all the GitBlame features.
    -- b = {
    --   name = '[b]lame',
  ...
  h = {
    name = '[h]elp / [h]ide / [h]unk',
    s = { ':Gitsigns stage_hunk', '[s]tage hunk ' },
    r = { ':Gitsigns reset_hunk', '[r]eset hunk' },
    p = { ':Gitsigns preview_hunk<cr>', '[p]review hunk' },
    d = { ':Gitsigns diffthis<cr>', 'start [d]iff for this file or so' }, -- TODO: What is the utility of the Gitsigns diff vs the Diffview.nvim one? Diffview seems better so far...
    D = {
      function()
        require('gitsigns').diffthis '~'
      end,
      'end [D]iff this file or so',
    },
    c = {
      name = '[c]onceal', -- where would I use this??
  ...
  o = {
    name = '[o]bsidian',
    d = { ':ObsidianToday<cr>', 'obsidian [d]aily' },
    -- t = { ':ObsidianToday 1<cr>', 'obsidian [t]omorrow' },
    t = { ':ObsidianTemplate<cr>', 'obsidian [t]emplate' },
    y = { ':ObsidianToday -1<cr>', 'obsidian [y]esterday' },
    b = { ':ObsidianBacklinks<cr>', 'obsidian [b]acklinks' },
    l = { ':ObsidianLink<cr>', 'obsidian [l]ink selection' },
    f = { ':ObsidianFollowLink<cr>', 'obsidian [f]ollow link' },
    n = { ':ObsidianNew<cr>', 'obsidian [n]ew' },
    s = { ':ObsidianSearch<cr>', 'obsidian [s]earch' },
    o = { ':ObsidianQuickSwitch<cr>', 'obsidian [o]pen quickswitch' },
    O = { ':ObsidianOpen<cr>', 'obsidian [O]pen in app' },
  },
  q = {
    name = '[q]uarto',
